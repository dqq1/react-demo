# @tms/sF-repo-front 基于 dumi + father-build + lerna 多包管理模版
...
-   packages
    ...
    -   hooks ---> @tms/hook 通用 hooks，不涉及业务逻辑
    -   component---> @tms/sF-component 通用组件，不涉及业务逻辑
...
lerna run --scope @tms/component test # 运行 @tms/component 模块下的 test
```
...
[lerna yarn workspace 实践](https://juejin.cn/post/6844903918279852046#heading-14)
